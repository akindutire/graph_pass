      ...
      <div class="mainbar">
        <div class="article">
          ...
          <div class="post_content" style="background:white; color:black;">
           ...
           <!--<h1>Signatures</h1>-->
           <h2 style="color:green;">0  Matched Point</h2>
           ...
           <table style="height:0px; width:20px;" id="tab1">
           ...
           <ee>
            ...
            ?>
              ...
              <br><br>
              <button type="button" id="btn_load_more2" data-val="<?php echo $user; ?>" >Load Image</button>
